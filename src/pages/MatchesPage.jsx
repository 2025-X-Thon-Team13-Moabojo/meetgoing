                                ...
                                {sentApplications.length > 0 ? sentApplications.map(app => (
                                    <div key={app.id} className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-lg hover:border-indigo-300 transition-colors">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">Applied for <span className="font-medium text-indigo-600">{app.role}</span></p>
                                    ...
                                    <div className="text-center py-8 text-gray-500">No sent applications found.</div>
                                )}
                            </div>
                        ) : (
                            <div className="space-y-4">
                                {receivedInvitations.length > 0 ? receivedInvitations.map(invite => (
                                    <div key={invite.id} className="p-4 bg-white border border-gray-200 rounded-lg hover:border-indigo-300 transition-colors">
                                        <div className="flex items-center justify-between mb-2">
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600">Invited for <span className="font-medium text-indigo-600">{invite.role}</span></p>
                                            </div>
                                            <div>
                                    ...
                                    <div className="text-center py-8 text-gray-500">No invitations received.</div>
                                )}
                            </div>
                        )}
                    </div>
